const FeatureSliderItem = props =>
	<div className="features-slider_item">
		<div className="features-img" style={{backgroundImage: `url(./images/${props.number}.svg)`}}></div>
		<div className="features-feature">{props.advantage} целевое преимущество</div>
	</div>;
			...
			<div className="features-wrapper">
				...
				<div className="features-slider">
					<div className="features-slider_items">
						<FeatureSliderItem number="1" advantage="Первое"/>
						<FeatureSliderItem number="2" advantage="Второе"/>
						<FeatureSliderItem number="3" advantage="Третье"/>
						<FeatureSliderItem number="4" advantage="Четвертое"/>
					</div>
